...
class UEBridge:
    ...
    def set_actor_property(
        self, name: str, property_name: str, property_value: str
    ) -> dict:
        return self.call(
            "set_actor_property",
            name=name,
    ...
    def set_viewport_transform(
        self, *, location: List[float] = None, rotation: List[float] = None
    ) -> dict:
    ...
    def auto_layout_subtree(
        self,
        *,
        root_node_id: str = None,
        blueprint_name: str = None,
        graph_name: str = None,
        max_pure_depth: int = None,
        layer_spacing: float = None,
        row_spacing: float = None,
    ) -> dict:
        return self.call(
    ...
    def set_blueprint_parent_class(
        self, blueprint_name: str, parent_class: str
    ) -> dict:
        return self.call(
    ...
    def remove_blueprint_interface(
        self, blueprint_name: str, interface_name: str
    ) -> dict:
        return self.call(
    ...
    def create_colored_material(
        self, material_name: str, *, color: List[float] = None, path: str = None
    ) -> dict:
        return self.call(
    ...
    def add_blueprint_input_action_node(
        self, blueprint_name: str, action_name: str, *, node_position: str = None
    ) -> dict:
        return self.call(
    ...
    def add_blueprint_self_reference(
        self, blueprint_name: str, *, node_position: str = None, graph_name: str = None
    ) -> dict:
        return self.call(
    ...
    def add_blueprint_branch_node(
        self, blueprint_name: str, *, graph_name: str = None, node_position: str = None
    ) -> dict:
        return self.call(
    ...
    def delete_blueprint_variable(
        self, blueprint_name: str, variable_name: str
    ) -> dict:
        return self.call(
    ...
    def rename_blueprint_variable(
        self, blueprint_name: str, old_name: str, new_name: str
    ) -> dict:
        return self.call(
    ...
    def delete_blueprint_function(
        self, blueprint_name: str, function_name: str
    ) -> dict:
        return self.call(
    ...
    def set_material_property(
        self, material_name: str, property_name: str, property_value: str
    ) -> dict:
        return self.call(
    ...
    def create_material_instance(
        ...
        *,
        path: str = None,
        scalar_parameters: dict = None,
        vector_parameters: dict = None,
    ) -> dict:
        return self.call(
    ...
    def create_post_process_volume(
        ...
        *,
        location: List[float] = None,
        infinite_extent: bool = None,
        priority: float = None,
        post_process_materials: List[str] = None,
    ) -> dict:
        return self.call(
            ...
            priority=priority,
            post_process_materials=post_process_materials,
        )
    ...
    def create_input_mapping(
        self, action_name: str, key: str, *, input_type: str = None, scale: float = None
    ) -> dict:
        return self.call(
    ...
    def create_input_action(
        self, name: str, *, value_type: str = None, path: str = None
    ) -> dict:
        return self.call(
            "create_input_action", name=name, value_type=value_type, path=path
        )
    ...
    def add_key_mapping_to_context(
        self,
        context_name: str,
        action_name: str,
        key: str,
    ...
    def bind_widget_event(
        self, widget_name: str, widget_component_name: str, event_name: str
    ) -> dict:
        return self.call(
            "bind_widget_event",
            widget_name=widget_name,
    ...
    def add_widget_to_viewport(self, widget_name: str, *, z_order: int = None) -> dict:
        return self.call(
            "add_widget_to_viewport", widget_name=widget_name, z_order=z_order
        )
    ...
    def rename_widget_in_blueprint(
        self, widget_name: str, target: str, new_name: str
    ) -> dict:
        return self.call(
            "rename_widget_in_blueprint",
            widget_name=widget_name,
            target=target,
            new_name=new_name,
        )
    ...
    def add_widget_child(self, widget_name: str, child: str, parent: str) -> dict:
        return self.call(
            "add_widget_child", widget_name=widget_name, child=child, parent=parent
        )

    def delete_widget_from_blueprint(self, widget_name: str, target: str) -> dict:
        return self.call(
            "delete_widget_from_blueprint", widget_name=widget_name, target=target
        )
