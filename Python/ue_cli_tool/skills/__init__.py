...
SKILL_DEFS: list[SkillDef] = [
	...
	SkillDef(
		...
		action_ids=(
			...
			# v0.4.0: Widget Analysis
			"widget.describe_full",
			"widget.list_animations",
			"widget.create_animation",
			"widget.add_animation_track",
			"widget.get_references",
			"widget.get_referencers",
			"widget.batch_get_styles",
		),
	...
	SkillDef(
		...
		action_ids=(
			...
			# Compile
			"animgraph.compile",
			# v0.4.0: Animation Analysis
			"anim.describe_blueprint_full",
			"anim.describe_montage",
			"anim.describe_blendspace",
			"anim.list_notifies",
			"anim.add_notify",
			"anim.remove_notify",
			"anim.get_skeleton_hierarchy",
		),
