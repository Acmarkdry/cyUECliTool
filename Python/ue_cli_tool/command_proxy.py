...
Usage:
    ...
    # Call by action id (dot 鈫?underscore)
...
class CommandProxy:
    ...
    2. Match on action_id with first ``_`` 鈫?``.`` (e.g. ``blueprint_create`` 鈫?``blueprint.create``)
    3. Fallback: try replacing all ``_`` with ``.`` (e.g. ``node_add_event`` 鈫?``node.add_event``)
    ...
    def _resolve_action(self, name: str) -> Optional[ActionDef]:
        ...
        # Strategy 2: first underscore 鈫?dot  (blueprint_create 鈫?blueprint.create)
        if "_" in name:
            idx = name.index("_")
        ...
        # node_add_event 鈫?node.add_event, node_add.event, etc.
        parts = name.split("_")
        if len(parts) >= 2:
    ...
    # 鈹€鈹€ Dynamic dispatch 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    # 鈹€鈹€ Explicit call (bypasses registry lookup) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

    def call(self, command: str, **params: Any) -> dict:
        """Send a command directly by C++ command type name.

        Does NOT go through the registry 鈥?use this for commands that
    ...
    # 鈹€鈹€ Discovery 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
