        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "material_name": {
                        "type": "string",
                        "description": "Name of the target Material",
                    },
                    "expression_class": {
                        "type": "string",
                    ...
                    "node_name": {
                        "type": "string",
                        "description": "Unique name for this node (for later connection/reference)",
                    },
                    "position": {
                        "type": "array",
                        "items": {"type": "number"},
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "source_node": {
                        "type": "string",
                        "description": "Name of the source expression",
                    },
                    "source_output_index": {
                        "type": "integer",
                    ...
                    "target_node": {
                        "type": "string",
                        "description": "Name of the target expression",
                    },
                    "target_input": {
                        "type": "string",
                        "description": "Input pin name (A, B, Alpha, Input, etc.)",
                    },
                },
                "required": [
                    "material_name",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "node_name": {
                        "type": "string",
                        "description": "Name of the expression node",
                    },
                    "property_name": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "material_name": {
                        "type": "string",
                        "description": "Name of the Material to compile",
                    }
                },
                "required": ["material_name"],
            },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "instance_name": {
                        "type": "string",
                        "description": "Name for the material instance",
                    },
                    "parent_material": {
                        "type": "string",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "name": {
                        "type": "string",
                        "description": "Name for the volume actor",
                    },
                    "location": {
                        "type": "array",
                        "items": {"type": "number"},
                    ...
                    "infinite_extent": {
                        "type": "boolean",
                        "description": "Whether to apply everywhere (default: true)",
                    },
                    "priority": {
                        "type": "number",
                        "description": "Priority value (default: 0.0)",
                    },
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "new_expression_class": {
                        "type": "string",
                        "description": "Target expression type",
                    },
                    "new_properties": {
                        "type": "object",
                        "description": "Property overrides for the new node (optional)",
                    },
                },
