...
5. THE README SHALL 新增对 [yangskin/UEEditorMCP](https://github.com/yangskin/UEEditorMCP) 的致谢声明，说明本项目基于该仓库 fork 并扩展，感谢 @yangskin 在架构重构与功能增强方面的贡献
6. THE README SHALL 保留底部许可证部分对原始代码版权归属 @lilklon 的声明，并补充对 @yangskin 的版权说明
