...
>
> **本项目 fork 自 [yangskin/UEEditorMCP](https://github.com/yangskin/UEEditorMCP)。**  
> 感谢 [@yangskin](https://github.com/yangskin) 在架构重构与功能增强方面的贡献，本项目在其基础上进一步扩展了 AnimGraph 完整操作能力。
...
本项目同时 fork 自 [yangskin/UEEditorMCP](https://github.com/yangskin/UEEditorMCP)（MIT 许可证）。  
架构重构与功能增强部分版权归 [@yangskin](https://github.com/yangskin) 所有。  
